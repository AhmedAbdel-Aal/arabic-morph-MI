...
| E04a | code ready | TBD | `Qwen/Qwen3-1.7B-Base` | `base` | First-subword pooling ablation | `MODEL=Qwen/Qwen3-1.7B-Base SURFACE=base POOLING=first RUN_ID=E04a BATCH_SIZE=4 bash scripts/colab_run.sh` | TBD |
| E04b | code ready | TBD | `Qwen/Qwen3-1.7B-Base` | `base` | Mean-pooling ablation | `MODEL=Qwen/Qwen3-1.7B-Base SURFACE=base POOLING=mean RUN_ID=E04b BATCH_SIZE=4 bash scripts/colab_run.sh` | TBD |
| E05 | code ready | TBD | `Qwen/Qwen3-1.7B-Base` | `full` | Affixed-form stress test | `MODEL=Qwen/Qwen3-1.7B-Base SURFACE=full POOLING=last RUN_ID=E05 BATCH_SIZE=4 bash scripts/colab_run.sh` | TBD |
